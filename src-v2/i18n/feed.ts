...
const pt = {
  ...
  'feed.demoTitle': 'A atividade real é privada.', 'feed.demoBody': 'Inicia sessão e entra numa pelada para ver a respetiva história.',
...
const en: Record<Key, TranslationValue> = {
  ...
  'feed.demoTitle': 'Real activity is private.', 'feed.demoBody': 'Sign in and join a community to see its history.',
...
const es: Record<Key, TranslationValue> = {
  ...
  'feed.demoTitle': 'La actividad real es privada.', 'feed.demoBody': 'Inicia sesión y entra en una comunidad para ver su historia.',
...
const fr: Record<Key, TranslationValue> = {
  ...
  'feed.demoTitle': 'L’activité réelle est privée.', 'feed.demoBody': 'Connecte-toi et rejoins une communauté pour voir son historique.',
...
const de: Record<Key, TranslationValue> = {
  ...
  'feed.demoTitle': 'Echte Aktivitäten sind privat.', 'feed.demoBody': 'Melde dich an und tritt einer Community bei, um ihre Historie zu sehen.',
